...
export default function Hero() {
  return (
    <section id="home" className="relative flex min-h-screen items-start pt-24 lg:pt-20 xl:items-center xl:pt-0">
      {/* ================= Background ================= */}
      ...
      <div className="section-container relative py-8">
        ...
        >
          {/* ================= Left Column ================= */}
          <div className="order-2 flex flex-col items-center text-center lg:items-start lg:text-left lg:order-1">
            {/* Badge */}
          ...
          <motion.div
            variants={item}
            className="flex justify-center lg:justify-end order-1 mb-10 lg:mb-0 lg:order-2
            scale-90 sm:scale-100 lg:scale-110"
          >
            <ProfileImage />
          </motion.div>
        </motion.div>
